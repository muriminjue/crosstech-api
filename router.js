...
//---staff--
router.get("/staff", checkauth, issystemadmin, controllers.staff.getall);
router.get("/staff/:email", checkauth, controllers.staff.getone);
router.post("/staff", /*checkauth,*/ controllers.staff.addone);
router.put("/staff/:email", checkauth, issystemadmin,controllers.staff.editone);
router.delete("/staff/:email", checkauth,issystemadmin, controllers.staff.deleteone);

//---user--
router.post("/user", /* checkauth, issystemadmin,*/ controllers.user.adduser);
...
router.get("/allroles", checkauth,issystemadmin, controllers.user.getroles);
router.put("/updateimage/:username",checkauth, controllers.user.updateimage)
router.put("/changeuserroles/:username", checkauth,issystemadmin, controllers.user.changeUseroles)
...
router.get("/bp/retailers/:id",checkauth, controllers.retailers.getone)
router.get("/bp/retailers",checkauth, controllers.retailers.getall)
router.post("/bp/retailers", checkauth, controllers.retailers.addone)
router.get("/bp/retailerdetailed", checkauth, controllers.retailers.getalldetailed)
router.put("/bp/retailers/:id", checkauth, controllers.retailers.editone)
router.delete("/bp/retailers/:id", checkauth, controllers.retailers.deleteone)
...
router.post("/stock/otherreceipt/:id", checkauth, controllers.stocking.uploadOtherstockreceipt)
router.post("/stock/other/consume", checkauth, controllers.stocking.consumeotherstock)
